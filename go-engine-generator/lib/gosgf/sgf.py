...
class Sgf_game(object):
    ...
    def process_zip(self, dir_name, zip_file_name, data_file_name, game_list):
        ...
        for index in game_list:
            ...
            if name.endswith('.sgf'):
                ...
                sgf = self.from_string(content)
                sgf, go_board_no_handy = sgf, GoBoard(19)
                go_board, first_move_done = self.get_handicap_stone(go_board_no_handy, sgf)
        ...
        for index in game_list:
            ...
            if name.endswith('.sgf'):
                ...
                sgf = self.from_string(sgf_content)
    ...
    def get_handicap_stone(self, go_board, sgf):
